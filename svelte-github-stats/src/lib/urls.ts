...
export const defaultUsername = "Its-Just-Nans"
export const getUrls = (username: string) => {
    let urls = [
        ...
        username === defaultUsername && `https://next.ossinsight.io/widgets/official/compose-user-dashboard-stats/thumbnail.png?user_id=${ossInsightId}&image_size=auto`,
        ...
        username === defaultUsername && `https://svg-packages-stats.vercel.app/api?author=n4n5`,
        ...
        `https://github-profile-summary-cards.vercel.app/api/cards/productive-time?username=${username}&theme=default&utcOffset=0`,
        `https://github-profile-summary-cards.vercel.app/api/cards/profile-details?username=${username}&theme=default`,
        `https://github-profile-summary-cards.vercel.app/api/cards/most-commit-language?username=${username}&theme=default`,
